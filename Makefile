...
# Files to include
ASM_S = boot.asm gdt_asm.asm switch.asm syscalls_asm.asm
CPP_S = kernel.cpp sh.cpp kbd.cpp idt.cpp task.cpp gdt.cpp vfs.cpp testing/test.cpp testing/mem_test.cpp graphics/graphics.cpp paging.cpp syscalls.cpp
