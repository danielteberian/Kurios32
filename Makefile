...
CPP_S = kernel.cpp sh.cpp kbd.cpp idt.cpp task.cpp gdt.cpp vfs.cpp testing/test.cpp testing/mem_test.cpp graphics/graphics.cpp paging.cpp syscalls.cpp usr/uswitch.cpp usr/uload.cpp error.cpp debug.cpp
